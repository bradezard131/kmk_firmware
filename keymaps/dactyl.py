...
kb.keymap = [
    ...
    [
        ...
        KC.LSHIFT, KC.Z,    KC.X,        KC.C,        KC.V,      KC.B,             KC.N,      KC.M,      KC.COMMA,     KC.DOT,         KC.SLASH,    KC.ESC,
        ABSENT,    ABSENT,  KC.LBRACKET, KC.RBRACKET, KC.BSPACE, KC.SPACE,         KC.ENTER,  KC.DELETE, KC.PGUP,      KC.PGDN,        ABSENT,      ABSENT,
        ABSENT,    ABSENT,  KC.LALT,     TO_COLEMAK,  KC.LCTRL,  KC.LWIN,          KC.LEFT,   KC.RIGHT,  KC.UP,        KC.DOWN,        ABSENT,      ABSENT,
    ],
    ...
    [
        ...
        KC.LSHIFT, KC.Z,    KC.X,        KC.C,        KC.D,      KC.V,             KC.K,      KC.H,       KC.COMMA,    KC.DOT,         KC.SLASH,    KC.ESC,
        ABSENT,    ABSENT,  KC.LBRACKET, KC.RBRACKET, KC.BSPACE, KC.SPACE,         KC.ENTER,  KC.DELETE,  KC.PGUP,     KC.PGDN,        ABSENT,      ABSENT,
        ABSENT,    ABSENT,  KC.LALT,     TO_QWERTY,   KC.LCTRL,  KC.LWIN,          KC.LEFT,   KC.RIGHT,   KC.UP,       KC.DOWN,        ABSENT,      ABSENT,
    ],
